...
Open the tool you’re going to be using.

Ask your AI to help you build the following tool: 

- Take a markdown file as input – see markdown folder in repo for a sample (sample-input.md)
